    ...
    <section className="flex flex-col gap-16 py-12 relative rounded-xl">
      ...
      <div className="flex flex-col md:flex-row items-center gap-8 ">
        ...
        <div className="w-full md:w-1/3">
          <h2 className="text-4xl text-center md:text-left font-bold mb-4">
            <span className="text-white ">VirtuaGym</span>
          </h2>
          <p className="text-[--subtext] text-center md:text-left">
      ...
      <div className="flex flex-col md:flex-row-reverse items-center gap-8">
        ...
        <div className="w-full md:w-1/2 flex justify-center min-h-0 overflow-visible">
