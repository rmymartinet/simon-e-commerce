...
const ProgramsCard = ({
  ...
  useGSAP(() => {
    ...
    animateBlockReveal(badgeRef as unknown as RefObject<HTMLDivElement>, 0.8);
  }, []);
    ...
    <section className="w-full max-w-7xl">
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-8">
        {programData.map((program, index) => (
          <div className="relative" key={program.titlePlan}>
            {index === 1 && (
              <div
                ref={badgeRef}
            ...
            <div
              ...
              className={`group relative flex h-full flex-col overflow-hidden rounded-3xl ${index === 1 ? "border-2 border-violet-500" : "border border-white/10"} bg-[#121214]/80 shadow-[0_24px_80px_rgba(0,0,0,0.45)]`}
            >
