    ...
    <>
      {isDisplayNavBar && (
        <footer
          ...
          className="text-primary -z-50 flex min-h-[100dvh] flex-col justify-between overflow-hidden bg-red-400"
        >
          <div
            ref={footerContentRef}
            className="bg-secondary text-primary flex min-h-[100dvh] flex-col justify-between px-4"
          >
            ...
            <div className="relative mt-20 text-center text-[13vw] leading-none md:mt-0 md:text-[14vw]">
              <h1 className="slice slice-top text-primary font-extrabold uppercase leading-none">
                smcoaching
              </h1>
              <h1 className="slice slice-mid text-primary font-extrabold uppercase leading-none">
                smcoaching
              </h1>
              <h1 className="text-primary font-extrabold uppercase leading-none">
                smcoaching
              </h1>
            </div>
          </div>
