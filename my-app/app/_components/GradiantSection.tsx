        ...
        <div className="flex flex-col gap-32 pt-40 mb-10">
          <div className="flex flex-col gap-10">
            <div className="flex items-center gap-2">
              <div className="bg-white rounded-md p-4">logo</div>
              <h1 className="text-4xl">{title}</h1>
            </div>
            <span className="text-8xl">{subtitle}</span>
          </div>
          <p className="lg:text-2xl lg:w-[50vw] text-pretty">{description}</p>
        </div>
        <div className="flex flex-col">
          <div className="bg-white rounded-2xl h-[50vh] md:h-[70vh] lg:h-[80vh] flex flex-col-reverse  gap-10 lg:gap-0 lg:grid lg:grid-cols-custom p-4 lg:p-7">
            <h4 className="lg:col-start-1-end-2 pb-24">
